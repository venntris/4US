...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Rozpocznij") action Start()
        ...
        textbutton _("Załaduj") action ShowMenu("load")

        textbutton _("Opcje") action ShowMenu("preferences")

        if _in_replay:

            textbutton _("Zakończ") action EndReplay(confirm=True)

        elif not main_menu:

            textbutton _("Menu główne") action MainMenu()

        textbutton _("O grze") action ShowMenu("about")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("Wyjście") action Quit(confirm=not main_menu)
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Strona {}"), auto=_("Zapis automatyczny"), quick=_("Szybki zapis"))
...
screen preferences():
    ...
    use game_menu(_("Opcje"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Powrót")
                    textbutton _("Wyłączone") action Preference("rollback side", "disable")
                    textbutton _("Lewy") action Preference("rollback side", "left")
                    textbutton _("Prawy") action Preference("rollback side", "right")

                vbox:
                    style_prefix "check"
                    label _("Pomiń")
                    textbutton _("Niewidoczny") action Preference("skip", "toggle")
    ...
    use game_menu(_("Pomoc"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Myszka") action SetScreenVariable("device", "mouse")

                if GamepadExists():
                    textbutton _("Kontroler") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    hbox:
        label _("Escape")
        text _("Dostęp do menu gry.")

    hbox:
        label _("Ctrl")
        text _("Pomija dialog.")
    ...
    hbox:
        label _("Page Up")
        text _("Powrót do wcześniejszego dialogu.")

    hbox:
        label _("Page Down")
        text _("Przejście do późniejszego dialogu.")
...
screen mouse_help():
    ...
    hbox:
        label _("Scroll do góry")
        text _("Powrót do wcześniejszego dialogu.")

    hbox:
        label _("Scroll w dół")
